...
def showEndInterface(screen, cfg, score, highest_score):
    ...
    text_title = font_big.render("Time UP", True, (255, 0, 0))
    
    text_title_rect = text_title.get_rect()
    text_title_rect.centerx = screen.get_rect().test_centerx
    ...
    text_score.centerx = screen.get_rect().test_centerx
    text_score_rect.centery = screen.get_rect().centery - 10
    text_tip = font_small.render("Enter Q to quit the game or R to restart it", True, (255, 0, 0))
    ...
    while True:
        ...
        if text_tip_show_flag:
            screen.blit(text_tip, text_score_rect)
